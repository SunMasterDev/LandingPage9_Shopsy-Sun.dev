      ...
      <div className="container">
        ...
        mx-auto">
          ...
          <p data-aos="fade-up" className="text-xs text-gray-400">
            ...
            nostrum minus in quod accusantium et provident 
          </p>
        </div>
        {/* Body section */}
        <div>
            ...
            md:grid-cols-4 lg:grid-cols-5 place-items-center gap-5">
                {/* card section */}
                {
                    ProductsData.map((item)=>( // ระวัง { } กับ วงเล็บ ()
                        ...
                        className='space-y-3'>
                            ...
                            <div>
                                ...
                                <p className='text-sm text-gray-900 capitalize'>{item.color}</p>
                  ...
                  <div className='flex justify-center'>
                    ...
                    cursor-pointer bg-primary text-white py-1 px-2
